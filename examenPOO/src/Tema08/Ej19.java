...
public class Ej19 {
  ...
  public static long binarioOctal(long binario) {
    ...
    octal = tratamiento.pegaPorDetras(octal, 1);
    octal = tratamiento.voltea(octal);
    octal = tratamiento.quitaPorDetras(octal, 1);
    octal = tratamiento.quitaPorDelante(octal, 1);
    return octal;
  }
  ...
  public static long decimalBinario(long decimal) {
    ...
    binario = tratamiento.pegaPorDetras(binario, 1);
    binario = tratamiento.voltea(binario);
    return tratamiento.quitaPorDetras(binario, 1);
  }

  public static long octalBinario(long octal) {
    long binario = 0;
    for (int i = 0; i < tratamiento.digitos(octal); i++) {
      binario = binario * 1000 + decimalBinario(tratamiento.digitoN(octal, i));
    }
    return binario;
  }
