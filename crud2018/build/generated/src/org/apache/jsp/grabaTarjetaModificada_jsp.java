...
public final class grabaTarjetaModificada_jsp extends org.apache.jasper.runtime.HttpJspBase
    ...
    try {
      ...
      out.write("        ");
            ...
            String actualizacion = "UPDATE tarjeta_grafica SET "
                    ...
                    + "', estatura='" + Double.valueOf(request.getParameter("estatura"))
                    + "', peso='" + Double.valueOf(request.getParameter("peso"))
                    + "', nombre=" + request.getParameter("nombre")
                    + " WHERE gym_id=" + Integer.valueOf(request.getParameter("gym_id"));
      ...
      out.write("\n");
      out.write("        <br>\n");
      out.write("        <a href=\"index.jsp\" class=\"\"><span></span> Página principal</a>\n");
      out.write("    </body>\n");
      out.write("</html>");
    } catch (Throwable t) {
